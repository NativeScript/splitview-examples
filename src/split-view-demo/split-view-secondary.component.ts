...
export class SplitViewSecondaryComponent {
  ...
  people = signal<ListPerson[]>([
    {
      ...
      city: "London",
      status: "nice",
      reason: "Helped elderly neighbor",
      avatar: "👧",
    },
    {
      name: "Liam Chen",
      ...
      city: "Tokyo",
      status: "nice",
      reason: "Shared toys with sister",
      avatar: "👦",
    },
    {
      name: "Sofia Martinez",
    ...
    },
    {
      ...
      city: "Sydney",
      status: "nice",
      reason: "Said please and thank you",
      avatar: "👧",
    },
    {
      name: "Noah Williams",
    ...
    },
    {
      ...
      city: "Paris",
      status: "nice",
      reason: "Made birthday card for mom",
      avatar: "👧",
    },
    {
      name: "Lucas Garcia",
    ...
    const updated = this.people().map((p) => {
      if (p.name === person.name) {
        return {
          ...p,
          status:
            p.status === "nice" ? ("naughty" as const) : ("nice" as const),
        };
      }
      return p;
    });
  ...
  addRandomPerson() {
    ...
    const newPerson: ListPerson = {
      ...
      reason: isNice
        ? niceReasons[Math.floor(Math.random() * niceReasons.length)]
        : naughtyReasons[Math.floor(Math.random() * naughtyReasons.length)],
